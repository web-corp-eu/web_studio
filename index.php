				...
				<div class="logo_main col-lg-4 col-lg-offset-2">
			      ...
			      <nav class="navbar col-lg-3 col-lg-offset-2 mgt70">
			          <ul class="nav nav-pills ">
			            <li><a href="" class="biliboard"><span>About</span></a></li>
			            <li><a href="" class="biliboard"><span>Portfolio</span></a></li>
...
<div class="pricing-tables block container">
    <ul class="pricing-table col-lg-3">
      ...
      <li>Round I: 50 sketches</li>
      <li>Round II: 4 unique ideas</li>
      <li>Round III: 2 refined</li>
      <li>Round IV: 1 finalized</li>
      <li class="deliverables">Delivery: AI</li>
    ...
    <ul class="pricing-table col-lg-3">
      ...
      <li>Round I: 100 sketches</li>
      <li>Round II: 6 unique ideas</li>
      <li>Round III: 3 refined</li>
      <li>Round IV: 1 finalized</li>
      <li class="deliverables">Delivery: AI, EPS</li>
      <li class="cta-button"><a href="#" class="button">Buy Now</a></li>
    </ul>
    <ul class="pricing-table col-lg-3">
      <li class="title">Identity</li>
      <li class="price">$350</li>
      <li class="description">Logo + Identity</li>
      <li>Round I: All Rounds</li>
      <li>+ Business cards</li>
      <li>+ Letterhead</li>
      <li>+ SNS covers (Facebook)</li>
      <li class="deliverables">Delivery: AI, EPS, SVG</li>
      <li class="cta-button"><a href="#" class="button">Buy Now</a></li>
    </ul>
    <ul class="pricing-table col-lg-3">
      <li class="title">Identity</li>
